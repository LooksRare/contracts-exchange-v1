...
uint256 constant ORDER_AMOUNT_CANNOT_BE_NULL = 201;
...
uint256 constant SIGNATURE_INVALID_ERC_1271 = 311;
...
uint256 constant MIN_NET_RATIO_ABOVE_ROYALTY_FEE_EIP2981_AND_PROTOCOL_FEE = 503;
...
uint256 constant ERC20_APPROVAL_INFERIOR_TO_AMOUNT = 711;
uint256 constant ERC20_BALANCE_INFERIOR_TO_AMOUNT = 712;
uint256 constant ERC721_NO_APPROVAL_FOR_ALL_OR_TOKEN_ID = 721;
uint256 constant ERC721_TOKEN_ID_NOT_IN_BALANCE = 722;
uint256 constant ERC1155_NO_APPROVAL_FOR_ALL = 731;
uint256 constant ERC1155_BALANCE_TOKEN_ID_INFERIOR_TO_AMOUNT = 732;
